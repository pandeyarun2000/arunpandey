			...
			<div className="mb-48">
				...
				<div className="mx-4 flex flex-col items-center justify-around rounded-xl border-2 border-cyan-400 bg-cyan-100 p-8 dark:border-0 dark:bg-gray-800 sm:mx-10 md:flex-row">
					...
					<p className="flex w-full max-w-2xl items-center text-center text-base md:mb-0 md:ml-10 md:text-lg">
						{`Bringing over 25 years of strategic sourcing expertise, I am a seasoned professional with a track record of success in diverse industries. My journey encompasses leadership roles in driving large-scale initiatives and spearheading transformation programs for renowned organizations and top-tier consulting firms. As a dedicated consultant, I am passionate about delivering impactful solutions and leveraging my extensive experience to navigate the dynamic landscape of strategic sourcing. Let's embark on the journey of excellence together.`}
					</p>
				</div>
			</div>
		</Fade>
